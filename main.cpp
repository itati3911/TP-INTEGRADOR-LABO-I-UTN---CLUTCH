...
//*******************************************************************************************************************
	...
	//bool cuantasQJugador1, cuantasQJugador2;
	...
	while(menuOpciones == 5){
		...
		while(menuOpciones == 1)
		{
			//*******************************************************************************************************
			//CUATRO REINAS
			bool cuantasQJugador1 = false;
			bool cuantasQJugador2 = false;
			...
			//MUESTRO CARTAS INICIALES JUGADOR 1
			...
			//cuantasQ = cuantasQ(manoJugador1, matrizSinMezclar);
			...
			//MUESTRO CARTAS INICIALES JUGADOR 2
			cout <<"  HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH" <<endl;
			for(int x = 0; x < 5; x++)
			{
			...
			//cuantasQ = cuantasQ(manoJugador2, matrizSinMezclar);
			...
			//cuantasQJugador1 = cuantasQ(manoJugador1, matrizSinMezclar);
			//cuantasQJugador2 = cuantasQ(manoJugador2, matrizSinMezclar);
			...
			do
			{
				...
				//*******************************************************************************************************
				//DETERMINO SI TIENE LAS 4 REINAS
			...
			}while(ganoElJugador1 == false && ganoElJugador2 == false);//ACA TERMINA EL DO WHILE DE LA PARTIDA
...
//**********************************************************************************************************************+
			...
			int pdv_ganarPartida = 0, pdv_robandoUltimaCarta = 0, pdv_turno = 0, pdv_sinSufrirRobo = 0, pdv_cuantasQJugador1=0, pdv_cuantasQJugador2=0;
			...
			if(ganoElJugador1 == true)
			{
				...
				//********************************************************************************************************
				//PUNTOS DE VICTORIA POR 4 REINAS
				if(cuantasQJugador1==true){
					puntosDeVictoriaQuienEmpieza+=50;
					pdv_cuantasQJugador1=50;
				}
			...
			else
			{
				...
				//********************************************************************************************************
				//PUNTOS DE VICTORIA POR 4 REINAS
				if(cuantasQJugador2==true){
					puntosDeVictoriaQuienNoEmpieza+=50;
					pdv_cuantasQJugador2=50;
				}
				//PUNTOS DE VICTORIA POR HABER GANADO LA PARTIDA
			...
			if(nombreJugadorGanador == jugador1){
                cout << " Gallinean Rhapsody: " << pdv_cuantasQJugador1 << " PDV" << endl;
			}
			else if(nombreJugadorGanador == jugador2){
                 cout << "  Gallinean Rhapsody: " << pdv_cuantasQJugador2 << " PDV" << endl;
			}
			cout << "------------------------------------------------------------------------" << endl;
			cout << "  TOTAL" << endl;
