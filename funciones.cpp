...
int cuantasQ(string manoJugador[], string matrizSinMezclar[][4])
{
    int contadorQ = 0;
    ...
    {
        //ACA PREGUNTO EN 1
        if (manoJugador[0] == matrizSinMezclar[2][y])
        {
            contadorQ++;
        }
        //ACA PREGUNTO EN 2
        if (manoJugador[1] == matrizSinMezclar[2][y])
        ...
        //ACA PREGUNTO EN 4
        if(manoJugador[3] == matrizSinMezclar[2][y])
        {
            contadorQ++;
        }
        //ACA PREGUNTO EN 5
        if(manoJugador[4] == matrizSinMezclar[2][y])
        {
            contadorQ++;
        }
    }
